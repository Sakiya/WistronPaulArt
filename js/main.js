...
(function () {
    ...
    const translations = {
        zh: {
            ...
            'work.8.image1': '江賢二藝術園區|恭源接待中心、承翰館 © Studio Mill pace',
            ...
            'work.8.description1': '在眾人企盼多年下，終將於3/15開幕。園區坐落於靜謐的太平洋邊，由著名藝術家江賢二的舊畫室擴建而成，這座融合「自然、藝術、建築」的傑作由台灣與德國兩地執業的林友寒建築師與江賢二共同設計，江賢二藝術園區共同發起人嚴長壽擔任館長。',
            // Footer
            'footer.organizer': '主辦',
            'footer.curator': '策展',
