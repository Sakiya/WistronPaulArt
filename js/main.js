...
(function () {
    ...
    const translations = {
        zh: {
            ...
            // 作品 8
            'work.8.title': '成為光：江賢二藝術園區的自然、建築、藝術',
            'work.8.image1': '江賢二藝術園區|恭源接待中心、承翰館 © Studio MillSpace',
            'work.8.image2': '江賢二藝術園區|明門廣場',
            'work.8.image3': '江賢二藝術園區 | 恭源接待中心',
            'work.8.image4': '江賢二藝術園區」明門廣場、〈Paul & Henry）、〈牧神的午後25-01〉',
            'work.8.image5': '江賢二藝術園區|靜池',
            'work.8.image6': '江賢二藝術園區| 勤誠館、靜池與銀湖走廊。攝影：John Tao',
            'work.8.description1': '歷經多年期待，江賢二藝術園區已於 2025 年 3 月 15 日正式開幕。園區坐落在靜謐的台東金樽，面向遼闊的太平洋，由江賢二的舊畫室擴建而成，這座融合「自然、藝術、建築」的創作基地由在台灣、德國兩地執業的建築師林友寒與江賢二共同設計，廖明彬董事長的清水建築工坊負責施工營建，以及台東建築師黃文榮整合在地的設計。',
            // Footer
            'footer.organizer': '主辦',
            'footer.curator': '策展',
        ...
        en: {
            ...
            // 作品 8
            'work.8.title': 'Becoming Light: Nature, Architecture, and Art of Paul Chiang Art Center',
            'work.8.image1': 'Paul Chaing Art Center | Kung-Yuan Reception Center and Gallery 3. © Studio MillSpace',
            'work.8.image2': 'Paul Chaing Art Center | Plaza',
            'work.8.image3': 'Paul Chaing Art Center | Kung-Yuan Reception Center',
